...
<div class="content-wrapper">
    ...
    <section class="content">
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-12 col-sm-6 col-md-3">
              ...
              <div class="info-box mb-3">
                <span class="info-box-icon bg-info elevation-1"><i class="fa fa-tasks" aria-hidden="true"></i></span>

                <div class="info-box-content">
                  <span class="info-box-text">Processing Task</span>
                  <span class="info-box-number">
                    {{$processingTaskCount}}
                  </span>
                </div>
          ...
          <div class="col-12 col-sm-6 col-md-3">
              <a href="{{route('admin.report.status-wise')}}?status=4&type=status-wise">
            <div class="info-box mb-3">
          ...
          <div class="col-12 col-sm-6 col-md-3">
            <a href="{{route('admin.report.status-wise')}}?status=3&type=status-wise">
            <div class="info-box mb-3">
        ...
        <div class="row">
          <div class="col-md-12">
            @include('adm.widget.latest-projects-employee')
          </div>
{{-- 
          <div class="col-md-4">
