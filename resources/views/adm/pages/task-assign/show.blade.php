...
$(document).ready(function () {
    $('html, body').animate({
        scrollTop: $('.card .content-header').offset().top
    }, 'slow');
    ...
    $(".chat-box").animate({ scrollTop: $('.last-msg-block').prop("scrollHeight")}, 1000);
                        ...
                        <div>
                            <div class="timeline-item m-0">
                                ...
                                <div class="container chat-box">
                                    <div class="card card-outline direct-chat direct-chat-dark shadow-none">
                                            ...
                                            @foreach($taskAssign->getAllComments($taskAssign->id) as $key => $task_comment)
                                                ...
                                                <div class="direct-chat-msg @if($taskAssign->getAllComments($taskAssign->id)->count() == $key + 1) last-msg-block @endif ">
                                ...
                                <form action="{{route('admin.taskComment.store')}}" method="post">
                                        ...
                                        <input type="hidden" name="admin_to" value="{{$taskAssign->admin_group}}">
