...
<div class="content-wrapper">
    ...
    <section class="content">
                ...
                <div class="col-12 col-md-12 col-lg-8 order-2 order-md-1">
                    ...
                    <div class="timeline no-before">
                        ...
                        <div class="timeline-item m-0">
                            ...
                            @foreach($taskAssign->getAllComments($taskAssign->id) as $key =>  $task_comment)
                            ...
                            @else
                                <div class="direct-chat-msg right comment-right">
                                    <div class="direct-chat-infos clearfix">
                                        ...
                                        <span class="direct-chat-name text-uppercase text-danger float-right">
                                        {{$taskAssign->getCommentUser($task_comment->admin_id)->name}}
                                        @if($task_comment->admin_to == session('LoggedUser')->id)
                                        <i style='style="font-size:17px;padding: 0px 8px;"' class='fas'>&#xf086;</i> You
                                        @else
                                        <i style='style="font-size:17px;padding: 0px 8px;"' class='fas'>&#xf086;</i> {{$taskAssign->getCommentUser($task_comment->admin_to)->name}}
                                        @endif
      ...
      <div class="demo" style="width:80%;">
         <textarea id="textarea"  name="comment"  class="form-control comment_area"></textarea>
      </div>
...
foreach($employeeArrs as $employeeArr){
    $getEmp = DB::table('employees')->where('id', $employeeArr)->first();
...
<html>
   ...
   <body>
      ...
      <script>
        ...
        // $.get( `{{url('api')}}/getEmployees/`, { id: parent })
        // .done(function( data ) {
