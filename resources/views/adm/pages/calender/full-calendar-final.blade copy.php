...
<script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.1.1/jquery.min.js"></script>
  ...
  <script src="{{asset('full-calendar-year')}}/fullcalendar.js"></script>
...
@include('adm.pages.calender.custom-right-click')
...
<div class="modal fade eventModal" id="modal-md">
        <div class="modal-dialog modal-md">
          <div class="modal-content">
            ...
            <form id="eventForm" method="post" action={{route('storeFullCalendar')}}>
                @csrf
                <input type="hidden" name="type" value="add">
                <div class="modal-body">
                    <textarea name="title" id="title" 
                    class="title form-control" placeholder="Event Title Here..." required
                    rows="" cols=""></textarea>
            ...
            <div class="form-group">
                ...
                <input type="text" name="end" id="end" placeholder="End Date & Time" class="form-control">
                    ...
                    <input type="color" id="color" class="color"
                        name="color" value="#27a744" list="reds" />
...
//         $( ".fc-content" ).bind( "taphold", tapholdHandler );
...
// }
         ...
         if(title)
            {
                ...
                $.ajax({
                    url:"/admin/full-calender/actionSave",
                    type:"POST",
                    data:{
                        title: title,
                        start: start,
    ...
    // $(".custom-menu").css({'top': event.pageY, 'left': event.pageX});
