                  ...
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <textarea class="form-control" name="kacheri_description"
                         placeholder="નોંધ">{{old('kacheri_description')}}</textarea>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <textarea class="form-control" name="petaKacheri_description"
                         placeholder="નોંધ">{{@old(petaKacheri_description)}}</textarea>
                  ...
                  <div class="form-group row">
                    <div class="col-sm-12">
                      <textarea class="form-control" name="department_description"
                         placeholder="નોંધ">{{@old('department_description')}}</textarea>
